		...
		<section class="price">
			<div class="cont">
				...
				<div class="price__about">
					Здесь вы можете посмотреть цены на услуги нашего фитнес-клуба и выбрать подходяющую для вас услугу.
				</div>	
				<div class="price__cards">
					<div class="price__card">
						<img src="img/price4.jpg" alt="" class="price__card-img">
					...
					<div class="price__card">
						<img src="img/price5.jpg" alt="" class="price__card-img">
						<div class="price__card-title">
							БАССЕЙН
						</div>
						<div class="price__card-info">
					...
					<div class="price__card">
						<img src="img/price6.jpg" alt="" class="price__card-img">
						<div class="price__card-title">
					...
					<div class="price__card">
						<img src="img/price7.jpg" alt="" class="price__card-img">
						<div class="price__card-title">
							БАННЫЙ КОМПЛЕКС
						</div>
						<div class="price__card-info">
					...
					<div class="price__card">
						<img src="img/price8.jpg" alt="" class="price__card-img">
						<div class="price__card-title">
							ФИТНЕС
						</div>
						<div class="price__card-info">
					...
					<div class="price__card">
						<img src="img/price9.jpg" alt="" class="price__card-img">
						<div class="price__card-title">
