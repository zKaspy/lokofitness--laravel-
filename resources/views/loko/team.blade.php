<html>
<head>
	<title>LOKO FINTESS - наша команда</title>
		...
		<section class="team">
			<div class="container">
				...
				<div class="about__team-info">
					LOKO FITNESS среди своих услуг предлагает занятия в тренажёрном зале с персональным тренером, который занимается с клиентом за отдельную плату и гарантирует результат.
				</div>
				<div class="instructors">
					...
					<div class="inst__card-img">
						<img src="{{ $member->img }}" width="260px" height="360px">
					</div>
						<h4 class="inst__card-title">{!! $member->position !!}</h4>
						<span class="inst__card-name">{{ $member->name }}</span>
						<p class="inst__card-age">Стаж {{ $member->experience }}.</p>
					</div>
