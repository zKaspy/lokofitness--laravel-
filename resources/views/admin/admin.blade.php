...
<body>
  ...
  <main>
    <div class="row">
      <div class="col s6">
        <div style="padding: 35px; text-align: center;" class="card">
          <div class="row">
          ...
          <div class="row">
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                ...
                <span class="indigo-text text-lighten-1"><h5>Отзывы</h5></span>
              </div>
            </a>
            <a href="{{ route('adminPages') }}">
              <div style="padding: 30px;" class="grey lighten-3 col s5 offset-s1 waves-effect">
                <i class="indigo-text text-lighten-1 large material-icons">pages</i>
