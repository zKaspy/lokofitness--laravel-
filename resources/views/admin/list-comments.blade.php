  ...
  <main>
    ...
    <ul class="collection">
        ...
        <li class="collection-item avatar">
          <span class="title">ID #{{ $comment -> id }}</span>
          <p>{{ $comment -> text }}</p>
          <a href="{{ route('adminCommentsGet', $comment -> id) }}" class="secondary-content" style="padding-top: 10px;"><i class="material-icons">send</i></a>
        </li>
